...
public class TestZooKeeperConnection {
	...
	public static void main(String args[]) throws Exception
	{
		...
		**/
		...
		znodeList = zk.getChildren("/webservice", true);
		...
		{
			byte[] bytearray = zk.getData("/webservice/"+str,true, zk.exists("/webservice/"+str,true));
			int counter=0;
			...
			System.out.println("Data from "+str+":"+znodeData);
